...
The CEID Coronavirus Tracker now includes a model to estimate the [final size of the ongoing COVID-19 outbreak](final-size.html). The model estimates global outbreak size by probabilistically incorporating the sparking of new local outbreaks across the globe. The model provides insight on best-case, worst-case and average-case scenarios under a range of assumptions, including how fast local containment efforts improve.
</p>
<div class="card-link">
